...
"""
import sqlite3, glob, re, sys, json
...
num2name = {}
for db in glob.glob('/Users/vaish/Library/Application Support/AddressBook/**/AddressBook-v22.abcddb', recursive=True):
    try:
...
im = sqlite3.connect('/Users/vaish/Library/Messages/chat.db')
